      ...
      <section className="correctness-shell px-6 py-12 md:px-10 md:py-16">
        <article className="correctness-paper correctness-type max-w-4xl mx-auto p-7 md:p-12 space-y-10">
          <header className="space-y-4 border-b border-[#5b4126]/20 pb-8">
            <p className="text-xs uppercase tracking-[0.2em] text-[#5b4126]/70">Correctness / Page 4</p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#1f1912]">Boundaries Define the Work</h2>
            <p className="text-[17px] leading-relaxed text-[#2a231c]">
              Reliability boundaries often reveal what kind of work is actually required.
            </p>
            <p className="text-[17px] leading-relaxed text-[#2a231c]">Without a boundary, a report such as:</p>
...
"we are getting bot detected"`}
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#1f1912]">Boundaries Let Organizations Operationalize Failures</h2>
            <p className="text-[17px] leading-relaxed text-[#2a231c]">
            ...
            <p className="text-[17px] leading-relaxed text-[#2a231c]">For example, a system can:</p>
            <ul className="space-y-2 text-[17px] text-[#2a231c] list-disc ml-6">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#1f1912]">Operations Becomes Higher-Value Work</h2>
            <p className="text-[17px] leading-relaxed text-[#2a231c]">
            ...
            <p className="text-[17px] leading-relaxed text-[#2a231c]">A reliability-boundary approach changes that dynamic.</p>
            <p className="text-[17px] leading-relaxed text-[#2a231c]">
            ...
            <p className="text-[17px] leading-relaxed text-[#2a231c]">Examples include:</p>
            <ul className="space-y-2 text-[17px] text-[#2a231c] list-disc ml-6">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#1f1912]">Boundaries Help With Build vs Buy Decisions</h2>
            <p className="text-[17px] leading-relaxed text-[#2a231c]">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#1f1912]">Boundaries Increase the Value of Errors</h2>
            <p className="text-[17px] leading-relaxed text-[#2a231c]">
            ...
            <p className="text-[17px] leading-relaxed text-[#2a231c]">For example:</p>
            <pre className="font-mono text-[13px] leading-relaxed whitespace-pre-wrap bg-white/40 border border-[#5b4126]/15 p-3 overflow-x-auto">
...
domain interface: changed`}
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#1f1912]">Boundaries Allow Domains to Compound Knowledge</h2>
            <p className="text-[17px] leading-relaxed text-[#2a231c]">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#1f1912]">What Reliability Boundaries Change</h2>
            <p className="text-[17px] leading-relaxed text-[#2a231c]">
              Reliability boundaries do not just help explain failures.
            </p>
            <p className="text-[17px] leading-relaxed text-[#2a231c]">They change:</p>
            <ul className="space-y-2 text-[17px] text-[#2a231c] list-disc ml-6">
