  ...
  return (
    <div className="max-w-3xl space-y-12">
      <header className="space-y-4 border-b border-[#E8E8E6] pb-8">
        <p className="text-xs uppercase tracking-[0.2em] text-[#8C8C8C] font-mono">Correctness / Page 4</p>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-light text-[#1A1A1A]">Boundaries Define the Work</h2>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
          Reliability boundaries often reveal what kind of work is actually required.
        </p>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">Without a boundary, a report such as:</p>
...
"we are getting bot detected"`}
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-light text-[#1A1A1A]">Boundaries Let Organizations Operationalize Failures</h2>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
        ...
        <p className="text-sm leading-relaxed text-[#5A5A5A]">For example, a system can:</p>
        <ul className="space-y-2 text-sm text-[#5A5A5A] list-disc ml-6">
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-light text-[#1A1A1A]">Operations Becomes Higher-Value Work</h2>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
        ...
        <p className="text-sm leading-relaxed text-[#5A5A5A]">A reliability-boundary approach changes that dynamic.</p>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
        ...
        <p className="text-sm leading-relaxed text-[#5A5A5A]">Examples include:</p>
        <ul className="space-y-2 text-sm text-[#5A5A5A] list-disc ml-6">
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-light text-[#1A1A1A]">Boundaries Help With Build vs Buy Decisions</h2>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-light text-[#1A1A1A]">Boundaries Increase the Value of Errors</h2>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
        ...
        <p className="text-sm leading-relaxed text-[#5A5A5A]">For example:</p>
        <pre className="font-mono text-xs leading-relaxed whitespace-pre-wrap bg-[#FFFFFF] border border-[#DADADA] p-3 overflow-x-auto text-[#2A2A2A]">
...
domain interface: changed`}
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-light text-[#1A1A1A]">Boundaries Allow Domains to Compound Knowledge</h2>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-light text-[#1A1A1A]">What Reliability Boundaries Change</h2>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
          Reliability boundaries do not just help explain failures.
        </p>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">They change:</p>
        <ul className="space-y-2 text-sm text-[#5A5A5A] list-disc ml-6">
