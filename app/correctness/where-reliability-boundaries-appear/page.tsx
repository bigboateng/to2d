  ...
  return (
    <div className="max-w-3xl space-y-12">
      <header className="space-y-4 border-b border-[#E8E8E6] pb-8">
        <p className="text-xs uppercase tracking-[0.2em] text-[#8C8C8C] font-mono">Correctness / Page 2</p>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-light text-[#1A1A1A]">What a Reliability Boundary Is</h2>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-light text-[#1A1A1A]">Model Output Boundary</h2>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
          Many automation systems rely on language models to generate structured actions or data.
        </p>
        <pre className="bg-[#FFFFFF] border border-[#DADADA] p-4 text-sm text-[#2A2A2A] overflow-x-auto">
{`{
  "action": "click",
  "target": "login_button"
}`}
        ...
        <div className="correctness-note p-4 md:p-5">
          ...
          <svg viewBox="0 0 900 360" className="w-full h-auto" role="img" aria-label="Default and robust reliability boundary sketch">
            <text x="30" y="32" fill="#5A5A5A" fontSize="15" fontFamily="ui-monospace, monospace">Default system (today)</text>

            <rect x="30" y="56" width="190" height="74" rx="8" fill="none" stroke="#B5B5B5" strokeWidth="2.1" strokeDasharray="8 5" />
            <text x="125" y="86" textAnchor="middle" fill="#1A1A1A" fontSize="17" fontFamily="ui-monospace, monospace">LLM</text>
            <text x="125" y="108" textAnchor="middle" fill="#5A5A5A" fontSize="13" fontFamily="ui-monospace, monospace">(probabilistic generator)</text>

            <line x1="220" y1="92" x2="308" y2="92" stroke="#B5B5B5" strokeWidth="2.1" />
            <polygon points="308,92 294,85 294,99" fill="#5A5A5A" />

            <rect x="318" y="62" width="130" height="60" rx="7" fill="none" stroke="#B5B5B5" strokeWidth="1.9" />
            <text x="383" y="98" textAnchor="middle" fill="#1A1A1A" fontSize="14" fontFamily="ui-monospace, monospace">Prompt</text>

            <line x1="448" y1="92" x2="565" y2="92" stroke="#B5B5B5" strokeWidth="2.1" />
            <polygon points="565,92 551,85 551,99" fill="#5A5A5A" />
            <text x="585" y="87" fill="#1A1A1A" fontSize="13" fontFamily="ui-monospace, monospace">Output</text>
            <text x="585" y="106" fill="#5A5A5A" fontSize="12" fontFamily="ui-monospace, monospace">failures can leak through</text>

            <line x1="30" y1="160" x2="860" y2="160" stroke="#B5B5B5" strokeWidth="1.3" strokeDasharray="6 6" />

            <text x="30" y="194" fill="#5A5A5A" fontSize="15" fontFamily="ui-monospace, monospace">Robust system</text>

            <rect x="30" y="218" width="190" height="74" rx="8" fill="none" stroke="#B5B5B5" strokeWidth="2.1" strokeDasharray="8 5" />
            <text x="125" y="248" textAnchor="middle" fill="#1A1A1A" fontSize="17" fontFamily="ui-monospace, monospace">LLM</text>
            <text x="125" y="270" textAnchor="middle" fill="#5A5A5A" fontSize="13" fontFamily="ui-monospace, monospace">(probabilistic generator)</text>

            <line x1="220" y1="254" x2="300" y2="254" stroke="#B5B5B5" strokeWidth="2.1" />
            <polygon points="300,254 286,247 286,261" fill="#5A5A5A" />

            <rect x="310" y="210" width="370" height="94" rx="10" fill="none" stroke="#B5B5B5" strokeWidth="2.3" strokeDasharray="10 6" />
            <text x="495" y="228" textAnchor="middle" fill="#5A5A5A" fontSize="13" fontFamily="ui-monospace, monospace">Reliability Boundary</text>
            <text x="495" y="260" textAnchor="middle" fill="#1A1A1A" fontSize="15" fontFamily="ui-monospace, monospace">interface parameters + constraints</text>
            <text x="495" y="281" textAnchor="middle" fill="#5A5A5A" fontSize="12" fontFamily="ui-monospace, monospace">validate / repair / retry / reject</text>

            <line x1="680" y1="254" x2="820" y2="254" stroke="#B5B5B5" strokeWidth="2.1" />
            <polygon points="820,254 806,247 806,261" fill="#5A5A5A" />
            <text x="830" y="248" fill="#1A1A1A" fontSize="13" fontFamily="ui-monospace, monospace">system output</text>
            <text x="830" y="268" fill="#5A5A5A" fontSize="12" fontFamily="ui-monospace, monospace">or boundary error</text>
          </svg>
        ...
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
          <a
            ...
            className="underline decoration-[#DADADA] underline-offset-4 hover:decoration-[#B5B5B5]"
          >
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-light text-[#1A1A1A]">Page Interpretation Boundary</h2>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
        ...
        <div className="correctness-note p-4 md:p-5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 text-[#5A5A5A]">
            <div className="border border-[#DADADA] bg-[#FFFFFF] p-4 space-y-3">
              <p className="text-sm font-semibold text-[#1A1A1A]">Boundary at selectors</p>
              <p className="text-sm text-[#8C8C8C]">Problem introduced: brittle click behavior when DOM assumptions change.</p>
              <div className="space-y-1 text-sm">
                <p>Website DOM</p>
                <p className="text-[#8C8C8C]">↓</p>
                <p>Screenshot capture</p>
                <p className="text-[#8C8C8C]">↓</p>
                <p className="border border-[#B5B5B5] border-dashed px-3 py-2 inline-block">Element lookup by selectors</p>
                <p className="text-[#8C8C8C]">↓</p>
                <p>Click action</p>
              </div>
              <div className="text-sm space-y-1">
                <p className="text-[#8C8C8C]">Example assumption:</p>
            ...
            <div className="border border-[#DADADA] bg-[#FFFFFF] p-4 space-y-3">
              <p className="text-sm font-semibold text-[#1A1A1A]">Boundary at interpretation layer</p>
              <p className="text-sm text-[#8C8C8C]">Problem introduced: if checks are missing, the system cannot explain boundary failures.</p>
              <div className="space-y-1 text-sm">
                <p>Website DOM</p>
                <p className="text-[#8C8C8C]">↓</p>
                <p>Screenshot capture</p>
                <p className="text-[#8C8C8C]">↓</p>
                <div className="border border-[#B5B5B5] border-dashed px-3 py-2">
                  <p className="font-semibold text-[#1A1A1A]">Page Interpretation Boundary</p>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-light text-[#1A1A1A]">Session and Authentication Boundary</h2>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
        ...
        <div className="correctness-note p-4 md:p-5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1.2fr_auto_1fr] gap-3 items-center [perspective:1100px] text-[#5A5A5A]">
            <div className="border border-[#DADADA] bg-[#FFFFFF] p-4 rounded-sm rotate-[-4deg]">
              <p className="text-sm font-semibold text-[#1A1A1A] mb-2">Login Screen</p>
              <div className="space-y-2 text-xs">
                <div className="border border-[#DADADA] px-2 py-1">email</div>
                <div className="border border-[#DADADA] px-2 py-1">password</div>
                <div className="border border-[#DADADA] px-2 py-1 bg-[#F2F2F0]">Sign in</div>
              </div>
            </div>

            <p className="text-[#8C8C8C] text-xl text-center">-&gt;</p>

            <div className="border border-[#B5B5B5] border-dashed bg-[#FFFFFF] p-4 rounded-sm space-y-3">
              <p className="text-sm font-semibold text-[#1A1A1A]">Reliability Boundary</p>
              <p className="text-xs text-[#8C8C8C]">HTML -&gt; Authentication / Web Storage Tech -&gt; Backend Authentication</p>
              <div className="relative h-[160px]">
                <div className="absolute left-2 top-2 w-[78%] h-[124px] border border-[#DADADA] bg-[#F2F2F0] rounded-sm" />
                <div className="absolute left-6 top-6 w-[78%] h-[124px] border border-[#DADADA] bg-[#FFFFFF] rounded-sm" />
                <div className="absolute left-10 top-10 w-[78%] h-[124px] border border-[#B5B5B5] bg-[#FFFFFF] rounded-sm p-3">
                  <p className="text-xs font-semibold text-[#1A1A1A] mb-1">Session State Stack</p>
              ...
              <div className="pt-1 text-xs text-[#8C8C8C]">
            ...
            <div className="border border-[#DADADA] bg-[#FFFFFF] p-4 rounded-sm rotate-[3deg]">
              <p className="text-sm font-semibold text-[#1A1A1A] mb-2">Service Backend</p>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-light text-[#1A1A1A]">Environment and Network Boundary</h2>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
      ...
      <section className="space-y-4 border-t border-[#E8E8E6] pt-8">
        <h2 className="text-xl font-light text-[#1A1A1A]">The Pattern</h2>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="border border-[#DADADA] bg-[#FFFFFF] p-4">
            <p className="font-semibold text-[#1A1A1A] mb-2">Inside the boundary</p>
            <p className="text-sm text-[#5A5A5A]">failure -> diagnosis -> recovery</p>
          </div>
          <div className="border border-[#DADADA] bg-[#FFFFFF] p-4">
            <p className="font-semibold text-[#1A1A1A] mb-2">Outside the boundary</p>
            <p className="text-sm text-[#5A5A5A]">failure -> guesswork</p>
          </div>
        </div>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
      ...
      <section className="space-y-4 border-t border-[#E8E8E6] pt-8">
        <h2 className="text-xl font-light text-[#1A1A1A]">A Note on Boundary Choice</h2>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
        ...
        <h3 className="text-lg font-light text-[#1A1A1A] pt-2">Prompt Guidance as Boundary Guidance</h3>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
        ...
        <h3 className="text-lg font-light text-[#1A1A1A] pt-2">Computer Use and Observability</h3>
        <p className="text-sm leading-relaxed text-[#5A5A5A]">
        ...
        <h3 className="text-lg font-light text-[#1A1A1A] pt-2">Boundary Choice as Product Advantage</h3>
        <div className="border border-[#DADADA] bg-[#FFFFFF] p-4 space-y-2">
          <p className="text-sm leading-relaxed text-[#5A5A5A]">
