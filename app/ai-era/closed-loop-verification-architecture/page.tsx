    ...
    <div className="space-y-12 max-w-3xl">
      ...
      <article className="prose max-w-none">
        <div className="text-[#5A5A5A] text-sm leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">1. Why LLM-driven systems need closed loops</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">2. The closed-loop structure</h2>
...
xₜ₊₁ = I(xₜ, yₜ)`}
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">3. What the verifier actually does</h2>
          ...
          <div className="border-l-2 border-[#DADADA] pl-6 my-6">
            <p className="text-[#2A2A2A] font-medium mb-2">Verifier Outputs</p>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">4. Real examples</h2>
          
          <div className="space-y-4">
            <div className="border-l-2 border-[#DADADA] pl-6">
              <p className="text-[#2A2A2A] font-medium mb-2">Example 1: Browser actions</p>
              <p className="text-[#5A5A5A] mb-2"><strong>Operator:</strong></p>
              <pre className="bg-[#FFFFFF] border border-[#E8E8E6] p-2 rounded overflow-x-auto font-mono text-xs mb-2">
                {`actions = f(DOM_slice)`}
              </pre>
              <p className="text-[#5A5A5A] mb-2"><strong>Verifier:</strong></p>
            ...
            <div className="border-l-2 border-[#DADADA] pl-6">
              <p className="text-[#2A2A2A] font-medium mb-2">Example 2: Document extraction</p>
              <p className="text-[#5A5A5A] mb-2"><strong>Operator:</strong></p>
              <pre className="bg-[#FFFFFF] border border-[#E8E8E6] p-2 rounded overflow-x-auto font-mono text-xs mb-2">
            ...
            <div className="border-l-2 border-[#DADADA] pl-6">
              <p className="text-[#2A2A2A] font-medium mb-2">Example 3: Compliance workflow</p>
              <p className="text-[#5A5A5A] mb-2"><strong>Operator:</strong></p>
              <pre className="bg-[#FFFFFF] border border-[#E8E8E6] p-2 rounded overflow-x-auto font-mono text-xs mb-2">
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">5. Why verification stabilizes the system</h2>
          
          <div className="space-y-4">
            <div>
              <p className="text-[#2A2A2A] font-medium">Prevents drift</p>
            ...
            <div>
              <p className="text-[#2A2A2A] font-medium">Limits error propagation</p>
              <p className="text-[#5A5A5A]">
            ...
            <div>
              <p className="text-[#2A2A2A] font-medium">Creates predictable boundaries</p>
              <p className="text-[#5A5A5A]">
            ...
            <div>
              <p className="text-[#2A2A2A] font-medium">Enables reusability</p>
              <p className="text-[#5A5A5A]">
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">6. Verifier design patterns</h2>
          
          <div className="space-y-3">
            <div>
              <p className="text-[#2A2A2A] font-medium">1. Schema validators</p>
            ...
            <div>
              <p className="text-[#2A2A2A] font-medium">2. Semantic validators (deterministic)</p>
              <ul className="text-[#5A5A5A] space-y-1 ml-6 list-disc text-sm">
            ...
            <div>
              <p className="text-[#2A2A2A] font-medium">3. State-dependent validators</p>
              <ul className="text-[#5A5A5A] space-y-1 ml-6 list-disc text-sm">
            ...
            <div>
              <p className="text-[#2A2A2A] font-medium">4. Cross-step consistency checks</p>
              <ul className="text-[#5A5A5A] space-y-1 ml-6 list-disc text-sm">
            ...
            <div>
              <p className="text-[#2A2A2A] font-medium">5. Error-correction rules</p>
              <ul className="text-[#5A5A5A] space-y-1 ml-6 list-disc text-sm">
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">7. Why retries are not verification</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">8. Closed-loop architecture is the backbone of verifiable agents</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">9. Example: End-to-end loop in a payroll workflow</h2>
          ...
          <ol className="text-[#5A5A5A] space-y-2 ml-6 list-decimal">
            ...
            <li><strong>Verifier:</strong>
              <ul className="text-[#8C8C8C] space-y-1 ml-6 list-disc text-sm mt-1">
