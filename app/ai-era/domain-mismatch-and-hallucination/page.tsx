    ...
    <div className="space-y-12 max-w-3xl">
      ...
      <article className="prose max-w-none">
        <div className="text-[#5A5A5A] text-sm leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">1. Hallucination as a domain error</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">2. Latent-space manifold boundaries</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">3. Structural ambiguity as the root cause</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">4. Attractor misalignment</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">5. Coherence is not correctness</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">6. Domain collapse under mixed signals</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">7. Why retrying doesn't fix it</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">8. The fix: enforce domain alignment before the operator</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">9. Formalizing domain mismatch</h2>
