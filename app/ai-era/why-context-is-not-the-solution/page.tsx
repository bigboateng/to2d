    ...
    <div className="space-y-12 max-w-3xl">
      ...
      <article className="prose max-w-none">
        <div className="text-[#5A5A5A] text-sm leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">1. Context expands the input space, not the structure</h2>
          ...
          <div className="border-l-2 border-[#DADADA] pl-6 my-6">
            <p className="text-[#2A2A2A] font-medium mb-2">Key point</p>
            <p className="text-[#5A5A5A]">
              Longer context increases uncertainty because it adds more degrees of freedom to the latent state.
            </p>
          </div>
          
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">2. Latent-state destabilization</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">3. Attention amplifies the wrong signals</h2>
          ...
          <div className="border-l-2 border-[#DADADA] pl-6 my-6">
            <p className="text-[#2A2A2A] font-medium mb-2">Result</p>
            <p className="text-[#5A5A5A]">
              The operator amplifies noise.
            </p>
          </div>
          
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">4. Mixed-domain context collapses the representation</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">5. Why adding more context increases hallucination</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">6. Why context hinders planning</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">7. Reliability = domain contraction, not expansion</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">8. Connection to 0-Context Architecture</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">9. Research directions</h2>
