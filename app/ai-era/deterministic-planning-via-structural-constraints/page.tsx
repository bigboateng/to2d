    ...
    <div className="space-y-12 max-w-3xl">
      ...
      <article className="prose max-w-none">
        <div className="text-[#5A5A5A] text-sm leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">1. The problem with free-form reasoning (and why agents fail in automation)</h2>
          ...
          <div className="border-l-2 border-[#DADADA] pl-6 my-6">
            <p className="text-[#2A2A2A] font-medium mb-2">Real automation examples</p>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">2. Deterministic planning = structure-first, language-second</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">3. Formal definition</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">4. Structural constraints (how to make planning automation-safe)</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">5. Real Example: Browser Planning</h2>
          
          <div className="space-y-4">
            <div>
              <p className="text-[#2A2A2A] font-medium mb-2">Bad: natural-language planning</p>
              <p className="text-[#5A5A5A]">
            ...
            <div>
              <p className="text-[#2A2A2A] font-medium mb-2">Deterministic plan</p>
...
{`{
  "steps": [
    ...
    { "action": "click", "selector": "#submit" }
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">6. Real Example: Document → Workflow Plans</h2>
          
          <div className="space-y-4">
            <div>
              <p className="text-[#2A2A2A] font-medium mb-2">Bad: "Write steps to process this document."</p>
              <p className="text-[#5A5A5A]">
            ...
            <div>
              <p className="text-[#2A2A2A] font-medium mb-2">Deterministic</p>
              <pre className="bg-[#FFFFFF] border border-[#E8E8E6] p-4 rounded overflow-x-auto font-mono text-sm mb-2">
{`{
  ...
  "steps": [
    ...
    ...
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">7. Representations that enforce correctness (critical for automation reliability)</h2>
          ...
          <div className="space-y-4">
            <div>
              <p className="text-[#2A2A2A] font-medium">1. Graph-based planning (for complex workflows)</p>
            ...
            <div>
              <p className="text-[#2A2A2A] font-medium">2. State-transition schemas (critical for browser automation)</p>
              <p className="text-[#5A5A5A] text-sm mb-2">
            ...
            <div>
              <p className="text-[#2A2A2A] font-medium">3. Canonical lists (for documents and forms)</p>
              <p className="text-[#5A5A5A] text-sm">
            ...
            <div>
              <p className="text-[#2A2A2A] font-medium">4. Action primitives (for all agent systems)</p>
              <p className="text-[#5A5A5A] text-sm mb-2">
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">8. How this enforces correctness without CoT or context</h2>
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">9. Enterprise Example: Why typical agents break and structural planning doesn't</h2>
          
          <div className="space-y-4">
            <div>
              <p className="text-[#2A2A2A] font-medium mb-2">Long-context, chain-of-thought planning (common but broken)</p>
              <ul className="text-[#5A5A5A] space-y-2 text-sm">
              ...
              <p className="text-[#5A5A5A] italic mt-2">
                This is why almost all current agent frameworks fail at scale.
              </p>
            </div>
            
            <div>
              <p className="text-[#2A2A2A] font-medium mb-2">Deterministic planning fixes all of this</p>
              <p className="text-[#5A5A5A]">
          ...
          <h2 className="text-xl font-light text-[#1A1A1A] mt-8 mb-4">10. Why deterministic planning is mandatory for large-scale automation</h2>
