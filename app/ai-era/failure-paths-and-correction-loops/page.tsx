    ...
    <div className="space-y-12 max-w-3xl">
      ...
      <article className="prose prose-invert max-w-none">
        <div className="text-white/70 text-sm leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">1. Why failure handling is the weakest part of most agents</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">2. Formal structure of failure paths</h2>
...
yₜ = V(uₜ)`}
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">3. Types of deterministic failure paths</h2>
          
          <div className="space-y-4">
            <div>
              <p className="text-white/80 font-medium">1. Reject & Re-extract</p>
            ...
            <div>
              <p className="text-white/80 font-medium">2. Reject & Canonicalize</p>
              <p className="text-white/60 text-sm mb-2">
            ...
            <div>
              <p className="text-white/80 font-medium">3. Fallback operator</p>
              <p className="text-white/60 text-sm mb-2">
            ...
            <div>
              <p className="text-white/80 font-medium">4. Escalation path</p>
              <p className="text-white/60 text-sm mb-2">
            ...
            <div>
              <p className="text-white/80 font-medium">5. Branch to alternative graph edge</p>
              <p className="text-white/60 text-sm mb-2">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">4. Real Example: Browser Automation Failure Loop</h2>
          
          <div className="space-y-4">
            <div>
              <p className="text-white/80 font-medium mb-2">Situation</p>
            ...
            <div>
              <p className="text-white/80 font-medium mb-2">Correct failure path</p>
...
4. Re-run operator f on new representation`}
            ...
            <div>
              <p className="text-white/80 font-medium mb-2">Incorrect (typical agent) behavior</p>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">5. Real Example: Document Extraction Failure Loop</h2>
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className="text-white/80 font-medium mb-2">Why this works</p>
              <p className="text-white/60">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">6. Real Example: Compliance / Payroll Workflow Failure</h2>
...
4. Re-run operator only for missing subset`}
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">7. Why deterministic correction stabilizes multi-step systems</h2>
          
          <div className="space-y-4">
            <div>
              <p className="text-white/80 font-medium">1. Localizes failure</p>
              <p className="text-white/60">
            ...
            <div>
              <p className="text-white/80 font-medium">2. Makes retries meaningful</p>
              <p className="text-white/60">
            ...
            <div>
              <p className="text-white/80 font-medium">3. Limits entropy growth</p>
              <p className="text-white/60">
            ...
            <div>
              <p className="text-white/80 font-medium">4. Maintains global consistency</p>
              <p className="text-white/60">
            ...
            <div>
              <p className="text-white/80 font-medium">5. Enables safe operator composition</p>
              <p className="text-white/60">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">8. Correction Loops in Graph-Based Workflows</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">9. Designing correction loops for large-scale automation</h2>
