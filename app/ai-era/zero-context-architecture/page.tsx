    ...
    <div className="space-y-12 max-w-3xl">
      ...
      <article className="prose prose-invert max-w-none">
        <div className="text-white/70 text-sm leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">1. What Zero‑Context Actually Means</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">2. Why Zero‑Context Systems Are Stable</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">3. Why long context destroys reliability</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">4. Real Example: Browser Automation</h2>
          
          <div className="space-y-4">
            <div>
              <p className="text-white/80 font-medium mb-2">Long-context version (what most agents do)</p>
            ...
            <div>
              <p className="text-white/80 font-medium mb-2">Zero‑context version</p>
...
actions = f(rₜ)`}
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">5. Real Example: Document Extraction</h2>
          
          <div className="space-y-4">
            <div>
              <p className="text-white/80 font-medium mb-2">Long-context agent</p>
              <p className="text-white/60">
            ...
            <div>
              <p className="text-white/80 font-medium mb-2">Zero‑context agent</p>
              <pre className="bg-white/5 border border-white/10 p-4 rounded overflow-x-auto font-mono text-sm mb-2">
...
fields = f(rₜ)`}
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">6. Real Example: HR / Payroll Workflows</h2>
          
          <div className="space-y-4">
            <div>
              <p className="text-white/80 font-medium mb-2">Long-context:</p>
            ...
            <div>
              <p className="text-white/80 font-medium mb-2">Zero‑context:</p>
              <pre className="bg-white/5 border border-white/10 p-4 rounded overflow-x-auto font-mono text-sm mb-2">
...
steps = f(rₜ)`}
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">7. Why Zero‑Context Enables Verification</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">8. Zero‑Context as a Control System</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">9. Why Zero‑Context Outperforms Every Open-Context Agent Design</h2>
          
          <div className="grid grid-cols-1 gap-3">
            <div className="border-l-2 border-white/20 pl-4">
              <p className="text-white/80 font-medium text-sm">1. No latent drift</p>
              <p className="text-white/60 text-sm">Each step is independent.</p>
            </div>
            
            <div className="border-l-2 border-white/20 pl-4">
              <p className="text-white/80 font-medium text-sm">2. No error accumulation</p>
              <p className="text-white/60 text-sm">History cannot corrupt future steps.</p>
            </div>
            
            <div className="border-l-2 border-white/20 pl-4">
              <p className="text-white/80 font-medium text-sm">3. No mixed domains</p>
              <p className="text-white/60 text-sm">The operator sees only one domain at a time.</p>
            </div>
            
            <div className="border-l-2 border-white/20 pl-4">
              <p className="text-white/80 font-medium text-sm">4. Reproducibility</p>
              <p className="text-white/60 text-sm">Same input slice → same output.</p>
            </div>
            
            <div className="border-l-2 border-white/20 pl-4">
              <p className="text-white/80 font-medium text-sm">5. Testability</p>
              <p className="text-white/60 text-sm">Each step is a pure function.</p>
            </div>
            
            <div className="border-l-2 border-white/20 pl-4">
              <p className="text-white/80 font-medium text-sm">6. Composability</p>
              <p className="text-white/60 text-sm">Operators can be chained like Lego blocks.</p>
            </div>
            
            <div className="border-l-2 border-white/20 pl-4">
              <p className="text-white/80 font-medium text-sm">7. Enterprise-grade determinism</p>
              <p className="text-white/60 text-sm">Perfect for payroll, compliance, operations, identity workflows, and browser tasks.</p>
            </div>
          </div>
          
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">10. How to Build a Zero‑Context Step</h2>
