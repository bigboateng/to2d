    ...
    <div className="space-y-12 max-w-3xl">
      ...
      <article className="prose prose-invert max-w-none">
        <div className="text-white/70 text-sm leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">1. What Domain Intelligence Actually Is</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">2. Why Domain Intelligence is the missing primitive in AI agents</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">3. The Two-Domain Transfer (To2D)</h2>
          
          <div className="border-l-4 border-white/20 pl-6 my-6">
            <p className="text-white/80 font-medium mb-2">The foundational formulation of this principle:</p>
            <p className="text-white/60 italic">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">4. Domain Intelligence as the key to verifiable automation</h2>
          ...
          <div className="space-y-4">
            <div>
              <p className="text-white/80 font-medium">Zero-Context Architecture</p>
            ...
            <div>
              <p className="text-white/80 font-medium">State-Space Modeling</p>
              <p className="text-white/60">
            ...
            <div>
              <p className="text-white/80 font-medium">Operator Composition</p>
              <p className="text-white/60">
            ...
            <div>
              <p className="text-white/80 font-medium">Verification Layers</p>
              <p className="text-white/60">
            ...
            <div>
              <p className="text-white/80 font-medium">Correction Loops</p>
              <p className="text-white/60">
            ...
            <div>
              <p className="text-white/80 font-medium">Deterministic Planning</p>
              <p className="text-white/60">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">5. Real Enterprise Meaning</h2>
          ...
          <div className="space-y-3">
            <div>
              <p className="text-white/80 font-medium">HR</p>
            ...
            <div>
              <p className="text-white/80 font-medium">Payroll</p>
              <p className="text-white/60 text-sm">
            ...
            <div>
              <p className="text-white/80 font-medium">Compliance</p>
              <p className="text-white/60 text-sm">
            ...
            <div>
              <p className="text-white/80 font-medium">Onboarding</p>
              <p className="text-white/60 text-sm">
            ...
            <div>
              <p className="text-white/80 font-medium">Document systems</p>
              <p className="text-white/60 text-sm">
            ...
            <div>
              <p className="text-white/80 font-medium">Browser automation</p>
              <p className="text-white/60 text-sm">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">6. Why this is a discovery, not a technique</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">7. Why this is the natural closing section</h2>
          ...
          <p className="text-white/80 font-medium text-base mt-6">
