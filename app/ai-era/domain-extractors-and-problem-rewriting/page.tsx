    ...
    <div className="space-y-12 max-w-3xl">
      ...
      <article className="prose prose-invert max-w-none">
        <div className="text-white/70 text-sm leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">1. Why domain extraction is necessary</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">2. Formal definition</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">3. Problem rewriting</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">4. Example: Browser automation (the most intuitive case)</h2>
          
          <div className="space-y-4">
            <div>
              <p className="text-white/80 font-medium mb-2">Raw input</p>
            ...
            <div>
              <p className="text-white/80 font-medium mb-2">Domain extractor</p>
            ...
            <div>
              <p className="text-white/80 font-medium mb-2">Rewriter</p>
              <pre className="bg-white/5 border border-white/10 p-2 rounded overflow-x-auto font-mono text-xs mb-2">
                {`rₜ = canonical_DOM_structure(zₜ)`}
              </pre>
              <p className="text-white/60">This may:</p>
              <ul className="text-white/50 space-y-1 ml-6 list-disc text-sm">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">5. Example: Document extraction</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">6. Example: Compliance / HR workflows</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">7. Why domain extractors stabilize LLMs</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">8. Representation rewriting patterns</h2>
          
          <div className="space-y-3">
            <div>
              <p className="text-white/80 font-medium">1. Canonicalization</p>
            ...
            <div>
              <p className="text-white/80 font-medium">2. Constraint encoding</p>
              <p className="text-white/60 text-sm">
            ...
            <div>
              <p className="text-white/80 font-medium">3. Goal specifying through structure</p>
              <p className="text-white/60 text-sm">
            ...
            <div>
              <p className="text-white/80 font-medium">4. Noise pruning</p>
              <p className="text-white/60 text-sm">
            ...
            <div>
              <p className="text-white/80 font-medium">5. Semantic flattening</p>
              <p className="text-white/60 text-sm">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">9. Why most agent frameworks fail</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">10. Link to 0-Context Architecture</h2>
