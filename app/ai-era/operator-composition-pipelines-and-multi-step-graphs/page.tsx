    ...
    <div className="space-y-12 max-w-3xl">
      ...
      <article className="prose prose-invert max-w-none">
        <div className="text-white/70 text-sm leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">1. Why composition matters</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">2. Formal structure of operator composition</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">3. Why composition stabilizes automation workflows</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">4. Real Example: Browser Automation Pipeline</h2>
          ...
          <div className="border-l-2 border-white/20 pl-6 my-6">
            <p className="text-white/80 font-medium mb-2">Composition matters because:</p>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">5. Real Example: Document → Workflow Graph</h2>
          ...
          <div className="border-l-2 border-white/20 pl-6 my-6">
            <p className="text-white/80 font-medium mb-2">Each operator handles one domain:</p>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">6. Multi-step graphs (beyond pipelines)</h2>
...
o₁ —→ o₃   o₄ —→ o₆
       ↘   ↗
         o₅`}
          ...
          <div className="border-l-2 border-white/20 pl-6 my-6">
            <p className="text-white/80 font-medium mb-2">The verifier ensures graph-level integrity</p>
            <ul className="text-white/60 space-y-1 text-sm">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">7. Why unverified composition fails</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">8. Composition and Zero-Context (how they connect)</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">9. Why this matters for large-scale automation</h2>
