    ...
    <div className="space-y-12 max-w-3xl">
      ...
      <article className="prose prose-invert max-w-none">
        <div className="text-white/70 text-sm leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">1. Why the oracle model fails</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">2. Operator viewpoint (control theory framing)</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">3. From reasoning to transformation</h2>
          ...
          <div className="border-l-2 border-white/20 pl-6 my-6">
            <p className="text-white/80 font-medium mb-2">Example (browser automation)</p>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">4. Why treating agents as operators increases reliability</h2>
          ...
          <div className="border-l-2 border-white/20 pl-6 my-6">
            <p className="text-white/80 font-medium mb-2">Example (extracting fields)</p>
            <p className="text-white/60 mb-2">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">5. Agents in a closed-loop system</h2>
          ...
          <div className="border-l-2 border-white/20 pl-6 my-6">
            <p className="text-white/80 font-medium mb-2">Example (enterprise onboarding)</p>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">6. Why this eliminates the magic</h2>
          ...
          <div className="border-l-2 border-white/20 pl-6 my-6">
            <p className="text-white/80 font-medium mb-2">Example (LLM):</p>
            <p className="text-white/60 mb-2">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">7. Building agents as operator pipelines</h2>
...
actions → browser_actuator`}
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">8. How this reframing solves real production failures</h2>
          
          <div className="space-y-4">
            <div className="border-l-2 border-white/20 pl-6">
              <p className="text-white/80 font-medium mb-2">Example: browser agent stuck in a loop</p>
              <p className="text-white/60 mb-2">
            ...
            <div className="border-l-2 border-white/20 pl-6">
              <p className="text-white/80 font-medium mb-2">Example: document extraction hallucinating values</p>
              <p className="text-white/60 mb-2">
...
fields → validator`}
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">9. Summary</h2>
