    ...
    <div className="space-y-12 max-w-3xl">
      ...
      <article className="prose prose-invert max-w-none">
        <div className="text-white/70 text-sm leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">Why "Transfer Function" is the Right Mental Model</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">Domain → Latent → Domain</h2>
          ...
          <div className="space-y-4 ml-4">
            <div>
              <p className="text-white/80 font-medium">1. Encoding (Domain → State)</p>
            ...
            <div>
              <p className="text-white/80 font-medium">2. Propagation (State → State)</p>
              <p className="text-white/60 ml-4">
            ...
            <div>
              <p className="text-white/80 font-medium">3. Decoding (State → Domain)</p>
              <p className="text-white/60 ml-4">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">The Core Insight</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">Operator Perspective vs Intelligence Perspective</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-white/10 p-4">
              <p className="text-white/80 font-medium mb-3">Intelligence Perspective:</p>
            ...
            <div className="border border-white/10 p-4">
              <p className="text-white/80 font-medium mb-3">Operator Perspective:</p>
              <ul className="text-white/60 space-y-2 text-sm">
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">Domain Mismatch</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">Domain Intelligence</h2>
          ...
          <h2 className="text-xl font-thin text-white/90 mt-8 mb-4">LLMs as Part of a Control Loop</h2>
